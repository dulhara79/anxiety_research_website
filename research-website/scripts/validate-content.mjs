...
const required = [
  ...
  'DiagonalMediaBand','variant="context"','variant="timescale"','variant="modality"','variant="component"','variant="fusion"','variant="architecture"','diagonal-media-band','diagonal-media-band--context','diagonal-media-band--timescale','diagonal-media-band--modality','diagonal-media-band--component','diagonal-media-band--fusion','diagonal-media-band--architecture','/media/context-diagonal-image.svg','clip-path:polygon(',
  'context-full-width-polygon','clip-path:polygon(0 100%,100% 24%,100% 100%)','object-fit:cover'
];
