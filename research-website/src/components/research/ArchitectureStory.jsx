...
export default function ArchitectureStory() {
  ...
  return (
    <section className="research-section architecture-section" id="system" data-section="architecture">
      <div className="shell">
        <TextReveal as="p" preset="eyebrow" className="eyebrow">SYSTEM ARCHITECTURE</TextReveal>
        ...
        <div className="architecture-flow" role="img" aria-label="Progressive research architecture">
          {architectureStages.map((stage, i) => (
            <motion.div
              ...
              viewport={{ once: false, amount: 0.55, margin: "-8% 0px -10% 0px" }}
        ...
        <motion.a className="text-link" href="https://github.com/dulhara79/R26-DS-012/blob/main/full.png" target="_blank" rel="noreferrer" whileHover={reduced ? undefined : { x: 5 }}>
