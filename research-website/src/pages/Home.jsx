...
export default function Home(){return <main><ResearchHero/><AnxietyContext/><ObservationTimeline/><SnapshotProblem/><LiteratureLandscape/><ResearchGap/><ResearchThesis/><ModalityOverview/><ComponentsStory/><FusionStory/><ArchitectureStory/><CurrentForecastSplit/><FindingsPreview/><ResearchInterpretation/><EvidenceSupport/><MethodologyStory/><section className="story-section documents-preview"><div className="shell"><p className="eyebrow">RESEARCH DOCUMENTS</p><h2>Public research outputs, organized by source and status.</h2><DocumentCollection compact/></div></section><ResearchTimeline/><section className="story-section team-preview"><div className="shell"><p className="eyebrow">TEAM & SUPERVISION</p><ResearchTeam compact/></div></section><Limitations/></main>}
